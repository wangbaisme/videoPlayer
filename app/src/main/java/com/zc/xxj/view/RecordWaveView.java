...
public class RecordWaveView extends RenderView {
    ...
    //控制向右偏移速度，越小偏移速度越快
    private float OFFSET_SPEED = 600F;
    //圆球的速度，越小速度越快
    private float CIRCLE_SPEED = 225F;
    //小球默认半径
    ...
    private void init(AttributeSet attrs) {
        ...
        SAMPLING_SIZE = t.getInt(R.styleable.RecordWaveView_ballSpeed, SAMPLING_SIZE);
        OFFSET_SPEED = t.getFloat(R.styleable.RecordWaveView_moveSpeed, OFFSET_SPEED);
        CIRCLE_SPEED = t.getFloat(R.styleable.RecordWaveView_ballSpeed, CIRCLE_SPEED);
