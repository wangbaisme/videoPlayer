...
public abstract class ItemModel implements ItemContract.ItemModel {

    private void getVideoInfoList(String moduleName){
    ...
    @Override
    public void updateData(String moduleName) {
        getVideoInfoList(moduleName);
    }

    public abstract void callBack(ArrayList<ModuleInfo> list);
}
